...
# TODO: make a Binomial class that inherits from the Distribution class. Use the specifications below.
    ...
    # TODO: write a method to output the sum of two binomial distributions. Assume both distributions have the same p value.
        ...
        # then try, except statement above will raise an exception if the p values are not equal
