'''
instructions here tells you how to install the python package in folder "package setup"

====INSTRUCTIONS START -- BESURE YOU ARE REFERENCING "package setup" FOLDER====
...
>> the "." (dot) tells pip to look for the setup.py file
>> might want to run this command "pip install --upgrade pip"
...
from distributions import Gaussian class

>> line above is UBER important!! you need to import this
...
====INSTRUCTIONS END -- BESURE YOU ARE REFERENCING "package setup" FOLDER====


..............EVERYTHING BELOW IS OPITIONAL SO YOU DON'T MESSUP YOUR DEFAULT PYTHON INSTALATION....
